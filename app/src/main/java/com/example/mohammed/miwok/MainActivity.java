...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            ...
            it was like CategoeryAdapter adapter = new CategoeryAdapter(getSupportFragmentManager());
            but we need to add context
        */
        // Create an adapter that knows which fragment should be shown on each page
        CategoeryAdapter adapter = new CategoeryAdapter(this,getSupportFragmentManager());
